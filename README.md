...
**Aligned scheduler**: selects the steps from [align your steps](https://research.nvidia.com/labs/toronto-ai/AlignYourSteps/howto.html) but for any given scheduler. Simple scheduler / 10 steps will give the same values as Comfy's implementation. I do not know if this is a good idea to select these steps on any other scheduler but simple.
